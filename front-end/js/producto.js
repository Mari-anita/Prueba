var url = "http://localhost:8081/api/shoes/producto/";
...
function consultarProductoID(id) {
    ...
    $.ajax({
        ...
        type: "GET",
        success: function (result) {
            document.getElementById("nombre_produc").value = result["nombre_produc"];
            document.getElementById("id_produc").value = result["id_produc"];
